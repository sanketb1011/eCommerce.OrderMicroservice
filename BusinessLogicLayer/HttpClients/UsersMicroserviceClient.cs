...
namespace BusinessLogicLayer.HttpClients
{
    public class UsersMicroserviceClient
    {
        ...
        public UsersMicroserviceClient(HttpClient httpClient,IDistributedCache distributedCache,ILogger<UsersMicroserviceClient> logger)
        {
        ...
        public async Task<UserDTO?> GetUserByUserID(Guid userID)
        {
            try
            {
                string cachedKey = $"user :{userID}";
                string? cachedUser =await _distributedCache.GetStringAsync(cachedKey);
